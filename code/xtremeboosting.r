...
# Read the data
train1 <- read.csv("E:\\UTD\\Fall 2016\\ML\\Project\\train.csv", header=TRUE)
test1 <- read.csv("E:\\UTD\\Fall 2016\\ML\\Project\\test.csv", header=TRUE)
...
write.csv(digit_predictions,'result_xgb-new1.csv',row.names=F)
